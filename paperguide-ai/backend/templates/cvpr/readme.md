# Overleaf LaTeX Package - CVPR 2026
...
2. **Verify Template**:
   - Ensure `cvpr_2026.sty` exists in project root
   - If missing, download from: https://cvpr.thecvf.com/Conferences/2026/AuthorGuidelines
...
4. **Add References**:
   ...
   - Use IEEE-style references for CVPR
...
- CVPR requires **full anonymization** for submission:
  - Remove author names, affiliations, emails
  - Remove acknowledgments
  - Remove self-identifying references
...
5. **Template**: Using official `cvpr_2026.sty`
6. **Format**: IEEE-style references with numbered citations
...
- Official Template: https://cvpr.thecvf.com/Conferences/2026/AuthorGuidelines
