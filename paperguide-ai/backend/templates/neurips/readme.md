# Overleaf LaTeX Package - NeurIPS 2026
...
2. **Verify Template**:
   ...
   - If missing, download from: https://neurips.cc/Conferences/2026/PaperInformation/StyleFiles
...
1. **Page Limit**: Confirm page count does not exceed 9 pages (main content)
...
5. **Checklist**: Include NeurIPS checklist if required
6. **Template**: Using official `neurips_2026.sty`
...
- Official Template: https://neurips.cc/Conferences/2026/PaperInformation/StyleFiles
