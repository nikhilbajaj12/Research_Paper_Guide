# Overleaf LaTeX Package - EMNLP 2026
...
2. **Verify Template**:
   - Ensure `emnlp_2026.sty` exists in project root
   - If missing, download from: https://2026.emnlp.org/call-for-papers/
...
- EMNLP requires **full anonymization** for submission:
...
5. **Template**: Using official `emnlp_2026.sty`
...
- Official Template: https://2026.emnlp.org/call-for-papers/
