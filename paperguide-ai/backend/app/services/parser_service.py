...
class ParserService:
    ...
    def parse(self, file_path: str, file_type: str, paper_id: str) -> ParsedDocument:
        ...
        return ParsedDocument(
            ...
            references_found=bool(raw.get("references_found", False)),
            citation_patterns_found=bool(raw.get("citation_patterns_found", False)),
            ...
            error=raw.get("error", None), # error can be None
        )
