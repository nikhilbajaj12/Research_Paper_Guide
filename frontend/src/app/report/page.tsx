...
import { AiChatPanel } from '@/components/report/AiChatPanel';
import { FixProgressPanel } from '@/components/report/FixProgressPanel';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <FixProgressPanel
              running={fixRunning}
              progress={fixProgress}
              steps={fixResult?.plan?.steps || []}
              agentResults={fixResult?.agent_results || []}
              scoreComparison={fixResult?.score_comparison}
              packageDownloadUrl={fixResult?.package_download_url}
              error={fixError}
              onStartFix={(command) => startFix(report.paper_id, report.conference_id, command)}
              onReset={resetFix}
            />
